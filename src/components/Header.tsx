      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative border-l border-gray-300 pl-6">
              <motion.button
                ...
                className="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition-colors px-3 py-2 rounded"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <Globe size={18} />
                  ...
                  >
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 hover:bg-blue-50 transition-colors flex items-center gap-2 ${
                        language === 'nl' ? 'bg-blue-50 text-blue-600' : 'text-gray-700'
                      }`}
                    >
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              <button onClick={handleHomeClick} className="block w-full text-left text-gray-700 hover:text-blue-600 transition-colors py-2">
                {t('home')}
              </button>
              <Link 
                to="/about"
              ...
              <button
                onClick={scrollToContact}
                className="w-full bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 mt-4"
              >
                <Phone size={18} />
                {t('contactUs')}
              </button>
