  ...
  return (
    <div className="pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="bg-blue-600 text-white w-20 h-20 rounded-2xl flex items-center justify-center mb-6">
            <FileText size={40} />
          </div>
        ...
        <div className="prose max-w-none">
          <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-xl mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            {[
              ...
              <div key={index} className="bg-white border border-gray-200 p-6 rounded-lg">
                <div className="text-blue-600 text-3xl mb-3">{index + 1}</div>
