  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="flex-shrink-0">
                    <div className="bg-blue-600 text-white w-20 h-20 rounded-2xl flex items-center justify-center">
                      <Icon size={40} />
                    </div>
                  </div>
        ...
        {/* CTA Section */}
        <motion.div 
          className="mt-16 bg-gradient-to-br from-blue-50 to-white p-8 rounded-xl text-center"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
